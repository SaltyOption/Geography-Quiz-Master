...
export const SEO_ARTICLES = [
  ...
  },
  {
    ...
    "cta": {
      ...
      "text": "Can you match each biome to its climate, its plants, and the regions where it appears — and place the Sahara, the Mongolian steppe, and the Arctic tundra where they belong on a blank map?",
      "buttons": [
        {
          "label": "Physical Geography quiz",
          "href": "/quiz/24"
