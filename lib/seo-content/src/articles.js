/**
 * Static SEO articles — the editorial content behind /articles.
 *
 * GENERATED from the design-handoff markdown (Updates/design_handoff_articles_homepage)
 * by a one-off script; edit this file directly for copy fixes. Each article's
 * FAQ and closing quiz-CTA sections were split out of the markdown body into
 * structured fields so every render path (client page, SSR, prerender) can lay
 * them out per the design (FAQ cards, CTA band) and emit FAQPage JSON-LD.
 *
 * Quiz links reference live production quiz ids / category slugs — the
 * "/quizzes" placeholders from the handoff have been resolved to real routes.
 * Consumed by:
 *   - artifacts/geo-quiz (homepage Articles section, /articles pages)
 *   - lib/ssr-bodies (crawler HTML)
 *   - artifacts/api-server (SSR routes, sitemap) and prerender.mjs
 */

export const SEO_ARTICLES = [
  {
    "slug": "smallest-country-in-the-world",
    "title": "What Is the Smallest Country in the World? (And 9 Runners-Up)",
    "tag": "Size & Scale",
    "metaDescription": "Vatican City is the smallest country in the world at just 0.49 km² — but the nine runners-up are just as fascinating. See the full top 10 with maps and facts.",
    "keywords": [
      "smallest country in the world",
      "smallest countries by area",
      "what is the smallest country"
    ],
    "illustration": "/articles/vatican-illustration.svg",
    "illustrationAlt": "Flat illustration of St. Peter's Basilica and its colonnade in Vatican City",
    "cardDescription": "Vatican City wins at 0.49 km² — but the nine runners-up are just as fascinating.",
    ...
    "faqs": [
      {
        "question": "What's the smallest country by population?",
        "answer": "Also Vatican City, with fewer than 1,000 residents. Among UN members, it's Tuvalu (around 11,000 people)."
      },
      {
        "question": "Is Sealand a country?",
        "answer": "No. The Principality of Sealand — a WWII sea fort off the English coast — declares itself a nation, but no country recognizes it. It's a micronation, not a microstate."
      },
      {
        "question": "What's the smallest country in Africa?",
        "answer": "The Seychelles (about 452 km²). On the African mainland, it's The Gambia."
      },
      {
        "question": "What's the smallest country in South America?",
        "answer": "Suriname — which, at over 163,000 km², is still more than 300,000 times larger than Vatican City. \"Small\" is relative."
      }
    ],
    "cta": {
      "heading": "Think You Know Your Microstates?",
      "text": "Vatican City, Monaco, and San Marino are easy — but can you find Nauru, Tuvalu, or the Marshall Islands on an unlabeled map of the Pacific?",
      "buttons": [
        {
          "label": "Countries of the World quiz",
          "href": "/quiz/26"
        },
        {
          "label": "Europe map quiz",
          "href": "/quiz/2"
        }
      ]
    },
