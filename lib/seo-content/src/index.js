 ...
 */
import { SEO_ARTICLES } from "./articles.js";

export { SEO_ARTICLES, getSeoArticle } from "./articles.js";
...
export const META_DESCRIPTIONS = {
  ...
  "/articles":
    "Geography articles from World Geography Trivia — the stories behind the quizzes. Microstates, split capitals, continental borders, World Cup 2026 geography, and more.",
  ...Object.fromEntries(
    SEO_ARTICLES.map((a) => [`/articles/${a.slug}`, a.metaDescription]),
  ),
  "/daily":
