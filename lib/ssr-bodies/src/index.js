...
export function guessTheCountryBody() {
  return pageMain(`  <h1 style="font-size:2rem;font-weight:700;margin-bottom:0.5rem">Where's Atlas?</h1>
  <p style="color:#6b7280">A daily geography guessing game from ${esc(SITE_NAME)}. Atlas the swallow has flown to a mystery country — find it in six guesses using capital-to-capital distance and direction hints. A new puzzle every day, the same for everyone.</p>
  <p style="margin-top:1rem"><a href="/guess-the-country" style="color:#0e7490;font-weight:600">Play today's puzzle →</a></p>`);
}
