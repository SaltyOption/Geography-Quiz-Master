 ...
 * italic, inline code, links, lists) are then turned into a fixed allow-list of
 * tags we generate ourselves. Link hrefs are restricted to http(s) and relative
 * URLs, so javascript:/data: and similar schemes are dropped to plain text.
 */
